...
// В случае, если канал закроют, мы сделаем этот каналу nil, что на выходе даст нам блокировку кейса, («Sending to a nil channel blocks forever»)
// дабы не выполнять лишних итераций в ожидании закрытия второго канала.
